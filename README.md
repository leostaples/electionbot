...
electionbot is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running electionbot Locally

You can test your hubot by running the following.

You can start electionbot locally by running:
...
Then you can interact with electionbot by typing `electionbot help`.

    electionbot> electionbot help

    electionbot> animate me <query> - The same thing as `image me`, except adds a few
